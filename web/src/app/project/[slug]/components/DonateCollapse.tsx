    ...
    <div className='collapse w-full bg-base-200'>
      ...
      <div className='collapse-content'>
        <form onSubmit={handleSubmit} className='flex flex-col justify-center'>
          <input readOnly={true} className='input input-bordered input-sm mt-2 w-full cursor-pointer' value={project.contractAddress} placeholder='Address' required={true} />
          <input
            name='value'
            ...
            required={true}
          />
          <textarea name='message' rows={3} className='textarea textarea-bordered mt-2 w-full' value={formData.message} onChange={handleInputChange} placeholder='Message' />
